...
<template>
  <div class="max-w-4xl mx-auto py-8 px-4">
    <h1 class="text-3xl font-bold text-gray-900 mb-8">ERC20 Assets</h1>

    <!-- ERC20 Asset Section -->
    <section class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
      <div class="flex justify-between items-center mb-6">
        <h2 class="text-xl font-bold text-gray-800">Your ERC20 Tokens</h2>
        <button 
          @click="scanTokens" 
      ...
      <div v-else-if="!scanning" class="text-center py-8 text-gray-500 bg-gray-50 rounded-lg border border-dashed border-gray-200 mb-8">
        No tokens found or scan not initiated. Click "Scan Assets" to fetch your tokens.
      </div>
      ...
      <div v-if="selectedToken" class="bg-gray-50 rounded-lg p-6 border border-gray-200 animate-fade-in">
        <div class="flex justify-between items-center mb-4">
          ...
          <button @click="selectedToken = null" class="text-gray-500 hover:text-gray-700 text-xl">&times;</button>
        </div>
        ...
        <div class="space-y-4">
          <div>
            ...
            <input 
              ...
              disabled 
              class="w-full px-4 py-2 bg-gray-100 border border-gray-300 rounded-lg text-gray-500 font-mono text-sm"
            />
          </div>
