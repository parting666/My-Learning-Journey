...
export const DeployERC1155 = () => {
    ...
    const userERC1155s = getContractsByType('ERC1155')
    ...
    const handleDeploy = () => {
        ...
        setSelectedContract('')
        deployERC1155(name, symbol, baseURI)
    }
    ...
    return (
        <div className="space-y-6 max-w-2xl mx-auto">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Deploy ERC1155 Collection</h3>
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-xs text-gray-500">
                            The base URL for token metadata. {`{id}`} will be replaced by the token ID.
                        </p>
                    </div>
              ...
              ${isPending || isConfirming
                    ...
                    >
                        {isPending ? 'Confirm in Wallet...' : isConfirming ? 'Deploying...' : 'Deploy ERC1155'}
                    </button>
                    ...
                    <div className="space-y-4">
                        <h4 className="text-md font-medium text-gray-900">Manage Your ERC1155 Collections</h4>
                        ...
                        <div>
                            ...
                            >
                                ...
                                {isConfirmed && contractAddress && !userERC1155s.find(c => c.contractAddress === contractAddress) && (
